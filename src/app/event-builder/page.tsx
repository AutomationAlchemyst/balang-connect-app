...
interface EventConfig {
  ...
  deliveryFee: number;
  totalPrice: number;
  eventDate?: Date; // Correctly typed as Date
  eventTime?: string;
}
...
export default function EventBuilderPage() {
  ...
  return (
    <div className="space-y-8">
                ...
                <div className="mt-4 p-4 bg-secondary/30 rounded-md">
                  ...
                  <p className="text-sm text-muted-foreground">{selectedPackage.description}</p>
                   {selectedPackage.isAllInclusive && (
                      ...
                      delivery (worth ${DELIVERY_FEE.toFixed(2)}) &amp; cups.</p>
                   )}
            ...
            <CardContent className="space-y-3">
              ...
              {displayDeliveryFee > 0 && (
                <div className="text-sm">
                  ...
                  <div className="pl-6">
                     <p>${DELIVERY_FEE.toFixed(2)} <span className="text-xs text-muted-foreground">(Applied for add-ons without an inclusive base package or non all-inclusive packages)</span></p>
                  </div>
                </div>
              )}
      ...
      {currentEventConfig && customerDetailsForPayment && (
        <PaymentConfirmationDialog
          isOpen={isPaymentModalOpen}
          onClose={resetBookingProcess}
          eventConfig={currentEventConfig as EventConfig & { eventDate: Date }} // Type assertion
